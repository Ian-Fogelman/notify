...
static void LoadInternal(ExtensionLoader &loader) {
    ...
    auto slack_webhook_function = ScalarFunction("notify_slack", {LogicalType::VARCHAR, LogicalType::VARCHAR, LogicalType::VARCHAR}, LogicalType::VARCHAR, SlackWebhookScalarFun);
